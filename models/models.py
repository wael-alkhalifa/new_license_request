...
class decisions(models.Model):
     ...
     rental_form = fields.Selection([('1', 'draft'),('2', 'payment'),('3','technical_authority_need'),('4', 'technical authority'),('5', 'sections'),('6','field_visit_need'),('7', 'Follow-up and evaluation'),('8', 'sections'),('9', 'section manager'),('10', ' general_manager'),('11', 'Legal advisor'),('12', ' general_manager'),('13', ' section manager'),('14', 'sections'),('15', ' section manager'),('16', 'general manager'),('17','General Secretary'),('18', 'payment'),('19','Delivery'),('20','reject'),('21', 'profile update'),('22', 'done')],'',default='1')
     ...
     license_renewal = fields.Selection([('1', 'draft'),('2', 'payment'),('3','technical_authority_need'),('4', 'technical authority'),('5', 'sections'),('6', 'section manager'),('7','conflict'),('8', 'Legal advisor'),('9', 'section manager'),('10', 'Business Names Registrar'),('11', ' section manager'),('12', ' sections'),('13', ' section manager'),('14', 'general manager'),('15','General Secretary'),('16', 'payment'),('17','Delivery'),('18','reject'),('19', 'profile update'),('20', 'done')],'',default='1')
     # typical_privileges = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'final decision'),('4', 'Delivery'),('5', 'archives'), ('10' ,'reject')],'state')
     # shapeliness_request = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'final decision'),('4', 'Delivery'),('5', 'archives'), ('10' ,'reject')],'state')
     # transportation_recommendation = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Transportation Committee'),('5', 'General Secretary confirm'),('6', ' final decision'),('7', 'Delivery'),('8', 'archives'),('10', 'reject')],string='state')
     model_exception = fields.Selection([('1', 'draft'),('2', 'payment'),('3', 'general manager'),('4', 'Cabinet confirm'),('5', 'Customs'),('6', 'profile'), ('7' ,'Done'),('10', 'reject')],'',default='1')
     ...
     modify_decision = fields.Selection([('1', 'draft'),('2', 'payment'),('3','technical_authority_need'),('4', 'technical authority'),('8', 'sections'),('9', 'section manager'),('10', ' general_manager'),('13', ' section manager'),('14', 'sections'),('15', ' section manager'),('16', 'general manager'),('17','General Secretary'),('18', 'payment'),('19','Delivery'),('20','reject'),('21', 'profile update'),('22', 'done')],'',default='1')
     # renewal_decision = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', ' final decision'),('7', 'Delivery'),('8', 'archives'),('10', 'reject')],string='state')
     change_activity = fields.Selection([('1', 'draft'),('2', 'payment'),('3','technical_authority_need'),('4', 'technical authority'),('5', 'sections'),('6','field_visit_need'),('7', 'Follow-up and evaluation'),('8', 'sections'),('9', 'section manager'),('10', ' general_manager'),('13', ' section manager'),('14', 'sections'),('15', ' section manager'),('16', 'general manager'),('17','General Secretary'),('18', 'payment'),('19','Delivery'),('20','reject'),('21', 'profile update'),('22', 'done')],'',default='1')
     # conduct_request = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', ' final decision'),('7', 'Delivery'),('8', 'archives'),('10', 'reject')],string='state')
     #mortgage_request = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', ' final decision'),('7', 'Delivery'),('8', 'archives'),('10', 'reject')],string='state')fields.Selection([('1', 'draft'),('2', 'sections'),('3', 'section manager'),('4', ' general_manager'),('5', 'Legal advisor'),('6', 'sections'),('7', ' section manager'),('8', 'general manager'),('9','General Secretary'),('10','Delivery'),('11','reject'),('12', 'profile update'),('13', 'done')],'',default='1')
     enter_partner = fields.Selection([('1', 'draft'),('2', 'payment'),('3','technical_authority_need'),('4', 'technical authority'),('5', 'sections'),('6','field_visit_need'),('7', 'Follow-up and evaluation'),('8', 'sections'),('9', 'section manager'),('10', ' general_manager'),('11', 'Legal advisor'),('12', ' general_manager'),('13', ' section manager'),('14', 'sections'),('14a', 'Business Names Registrar'),('14b', 'sections'),('15', ' section manager'),('16', 'general manager'),('17','General Secretary'),('18', 'payment'),('19','Delivery'),('20','reject'),('21', 'profile update'),('22', 'done')],'',default='1')
     # breakup_partnership = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', 'legal department confirm'),('7', 'Business Names Registrar'),('8', ' final decision'),('9', 'Delivery'),('10', 'archives'),('11', 'reject')],string='state')
     # change_businessname = fields.Selection([('1', 'draft'),('2', 'section confirm'),('4', 'Business Names Registrar'),('5', 'Delivery'),('6', 'archives'),('10', 'reject')],string='state')
     # transfer_ownership = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', 'legal department confirm'),('7', ' final decision'),('8', 'Delivery'),('9', 'archives'),('10', 'reject')],string='state')
     # reissued_request = fields.Selection([('1', 'draft'),('2', 'section confirm'),('3', 'Customs withdrawal'),('4', 'Prepare note'),('5', 'General Secretary confirm'),('6', ' final decision'),('7', 'Delivery'),('8', 'archives'),('10', 'reject')],string='state')
     cancel_license = fields.Selection([('1', 'draft'),('2', 'sections'),('3', 'section manager'),('5', 'commercial registrar'),('6', 'sections'),('7', ' section manager'),('8', 'general manager'),('9','General Secretary'),('10','Delivery'),('11','reject'),('12', 'profile update'),('13', 'done')],'',default='1')
     ...
     attachments = fields.Many2many('request.attachmens','attachmens')   
     note = fields.Html('')
     ...
     def update_profile(self):
          ...
          for rec in profile:
               ...
               #vals = { 'decision_details': [1,self.id]}
               #decision_details = rec.write(vals)
...
class request_attachmens(models.Model):
     ...
     nia_new_license = fields.Many2one('nia_new_license', '')
